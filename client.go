...
//
// Parameters:
//   - clientID: the twitch apps client id
//   - token: the oauth token associated with the client id
//   - httpClient: your httpClient you wish to use, if nil it uses http.DefaultClient
//
// Generate a token with all params using twitch cli
